            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                        <span class="glyphicon glyphicon-user" aria-hidden="true"></span> <span class="label label-primary"></span>【<@shiro.principal type="net.bubblyyi.base.entity.User" property="userCode"/>】
                    </a>
